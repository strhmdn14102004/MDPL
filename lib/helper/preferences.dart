...
class Preferences {
  ...
  static bool? getBool(PreferenceKey preferenceKey, [bool? defValue]) {
    return BasePreferences.getInstance().getBool(preferenceKey.name) ??
        defValue;
  }
  ...
  static double? getDouble(
    ...
    return BasePreferences.getInstance().getDouble(preferenceKey.name) ??
        defValue;
  }
  ...
  static String? getString(
    ...
    return BasePreferences.getInstance().getString(preferenceKey.name) ??
        defValue;
  }
  ...
  static List<String>? getStrings(
    ...
    return BasePreferences.getInstance().getStrings(preferenceKey.name) ??
        defValue;
  }
